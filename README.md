...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-s1cazm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-s1cazm.containers.anotherwebservice.com/
...
```
git clone git@github.com:anton-faber/container-s1cazm.git
cd container-s1cazm
```
...
```
docker attach container-s1cazm
```
